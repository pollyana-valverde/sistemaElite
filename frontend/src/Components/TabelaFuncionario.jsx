...
useEffect(() => {
  axios.get("http://localhost:3001/funcionario").then((res) => setFuncionario(res.data))
  setLoading(false);
  initFilters(); 
}, []);
...
setFilters({
    ...
    endereco: { operator: FilterOperator.AND, constraints: [{ value: null, matchMode: FilterMatchMode.ENDS_WITH }] },

    senha: { operator: FilterOperator.AND, constraints: [{ value: null, matchMode: FilterMatchMode.STARTS_WITH }] },
...
return (
  ...
  <div className="card">
      ...
      paginatorRight={paginatorRight}>
        ...
        <Column field="idFuncionario" sortable   header="idFuncionario" style={{ width: 'auto' }}></Column>
        ...
        <Column field="cargo" filter filterPlaceholder="Filtre pelo nome da impresa" sortable  header="cargo" editor={(options) => textEditor(options)} style={{ width: 'auto' }}></Column>
